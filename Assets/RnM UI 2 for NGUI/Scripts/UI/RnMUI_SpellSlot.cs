...
public class RnMUI_SpellSlot : RnMUI_IconSlot
{
	...
	protected override void Awake()
	{
		...
		if (this.cooldownHandle == null) this.cooldownHandle = this.gameObject.GetComponent<RnMUI_SlotCooldown>();
		if (this.cooldownHandle == null) this.cooldownHandle = this.gameObject.GetComponentInChildren<RnMUI_SlotCooldown>();
	}
