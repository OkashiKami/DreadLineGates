...
public class RnMUI_Tooltip : MonoBehaviour
{
	...
	public static void AddAttribute(string value, string text, RectOffset margin)
	{
		if (mInstance != null)
			mInstance._AddAttribute(value, text, false, margin);
	}
	...
	private float currentAlpha { get { return (this.background != null ? this.background.alpha : 0f); } }
